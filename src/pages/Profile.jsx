  ...
  return (
    <>
      <div className="w-full h-full flex flex-col justify-center items-center">
        <div className="xl:w-[768px] xl:h-[754px] lg:w-[756px] lg:h-[640px] md:w-[680px] md:h-[590px] sm:w-[340px] sm:h-[516px] flex flex-col justify-center items-center bg-neutral-white-100 rounded-3xl overflow-hidden shadow-main-shadow relative">
          <Link to="/home">
            <BtnBack />
          </Link>
          <div
